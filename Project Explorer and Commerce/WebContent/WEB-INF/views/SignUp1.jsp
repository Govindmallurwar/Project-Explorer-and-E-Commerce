...
<div style="padding:1px">
 <form:form action="register" method="post" modelAttribute="userModel" onsubmit="return validateMe()">
 ...
 left:20px; width: 715px; height:470px"">
  <legend><h1>Sign Up</h1></legend>
    ...
    <tr  style="padding-top: 10px"><td><h2>Password: </h2></td><td><input  type="password" name="password" placeholder="Password" id="first"/></td><td><form:errors path="password" cssClass="FieldError"></form:errors></td></tr>
     <tr  style="padding-top: 10px"><td><h2>Confirm Password: </h2></td><td><input type="password" placeholder="Confirm Password" id="second"/></td><td><form:errors path="password" cssClass="FieldError"></form:errors></td></tr>  
    ...
    <tr  style="padding-top: 10px"><td><h2>Contact No: </h2></td><td><form:input path="contactNumber" placeholder="ex:9876543210"/></td><td><form:errors path="contactNumber" cssClass="FieldError"></form:errors></td></tr>
     ...
     <tr  style="padding-top: 10px"><td><h2>Category: </h2></td><td><select name="category"><option value="Customer" selected="selected">Customer</option><option value="Vendor">Vendor</option></select></td><td><form:errors path="category" cssClass="FieldError"></form:errors></td></tr>
    ...
    <tr  style="margin-top: 20px;"><td colspan="1"><br><input type="submit" value="Register"></td><td colspan="1"><br><input type="submit" value="Cancel"></td></tr>
    </table><br><br>
 </fieldset>
 </form:form>
 </div>
